...
public class BottomBannersSliding_Adapter extends PagerAdapter {

    private ArrayList<Integer>  Imagesarraylist;
    Context mcontext;
    private LayoutInflater minflater;

    public BottomBannersSliding_Adapter(Context context,ArrayList<Integer> bottomarraylist)
    {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View imagelayoutview=minflater.inflate(R.layout.bottom_images_sliding_layout,container,false);


        final ImageView imageView =  imagelayoutview
                .findViewById(R.id.bottom_images_home_page);
